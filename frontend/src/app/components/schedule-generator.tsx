...
export function ScheduleGenerator({
  ...
  const [scheduleMode, setScheduleMode] = useState<"saved" | "preview">("saved");
  ...
  const getRoleRowsForShift = (
    ...
    const shiftTemplateId = Number(
      shiftTemplate.shift_template_id,
    );
    ...
    return staffingRequirements
      ...
      .flatMap((req) =>
        Array.from(
          { length: Number(req.required_count) },
          (_, index) => ({
